class RecipesController < ApplicationController
  ...
  def recipe_params 
    params.require(:recipe).permit(:title, :description, :prep_time, :prep_time_minutes, :cook_time, :cook_time_minutes, :ingredients, :image, :thaw_time, :user_id, category_ids: [])
  end
